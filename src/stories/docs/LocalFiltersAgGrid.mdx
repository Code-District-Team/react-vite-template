...
This story demonstrates the usage of the use of Ag-Grid for creating a data table with local filtering.
...
The code for the this component is structured as follows:
