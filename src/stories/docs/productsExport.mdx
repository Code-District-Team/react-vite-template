...
This story demonstrates a React component that provides a user interface for importing and exporting products.
...
4. Add following methods in the your React component
