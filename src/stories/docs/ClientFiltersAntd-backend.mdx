...
<Meta title="Features/Client Side Filters/Ant Design/Backend Docs" />

# Client Side Filters Ant Design Table Backend Docs

This story focuses on developing an API for fetching paginated records from a database, while searching, filtering, and sorting functionalities are handled efficiently on the client side using Ant Design.
